...
EXTERN   PcdGet32(PcdFspAreaBaseAddress):DWORD
...
@@:
  ...
  push      dword ptr [edx + 12] ; Code size
  push      dword ptr [edx + 8]  ; Code base
  push      dword ptr [edx + 4]  ; Microcode size, 0, no ucode for Quark
  push      dword ptr [edx]      ; Microcode base, 0, no ucode for Quark
